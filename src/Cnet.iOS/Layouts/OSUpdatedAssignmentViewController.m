//
//  OSUpdatedAssignmentViewController.m
...
#import "OSUpdatedAssignmentViewController.h"

@interface OSUpdatedAssignmentViewController ()

@end

@implementation OSUpdatedAssignmentViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        case 0:
            updatedCell = (OSUpdatedCell *) [tableView dequeueReusableCellWithIdentifier:@"UpdatedCellIdentifier"];
            return updatedCell;
            break;
