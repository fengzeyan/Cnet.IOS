...
extern void *mono_aot_module_TimesSquareiOSSample_info;
...
{
	mono_aot_register_module (mono_aot_module_TimesSquareiOSSample_info);
...
void monotouch_register_assemblies ()
{
	...
	monotouch_open_and_register ("TimesSquare.iOS.dll");
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "TimesSquareiOSSample.exe";
	mono_use_llvm = FALSE;
